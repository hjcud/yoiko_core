...
![유물 강화 마법진과 능력치 상승 과정](readme-assets/relic-upgrade.gif)

_강화 재료를 사용해 유물의 효과 수치를 높이는 과정_
...
![모래와 수면 구간을 달리는 거북이 경주](readme-assets/turtle-race.gif)

_모래와 수면 구간에서 진행되는 거북이 경주_
